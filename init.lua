...
-- hs.hotkey.bind(launch_mash, "4", function() ext.app.forceLaunchOrFocus("Google Chrome Canary") end)
-- hs.hotkey.bind(launch_mash, "4", function() ext.app.forceLaunchOrFocus("kitty") end)
